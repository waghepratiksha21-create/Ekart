pipeline {
    ...
    tools {
        maven 'maven3'
        jdk 'jdk-21' // Ensure this JDK is configured in Jenkins → Global Tool Configuration
    }
    ...
    stages {
        ...
        stage('Deploy to Nexus') {
            steps {
                withMaven(globalMavenSettingsConfig: 'global-maven', jdk: 'jdk-21', maven: 'maven3', traceability: true) {
